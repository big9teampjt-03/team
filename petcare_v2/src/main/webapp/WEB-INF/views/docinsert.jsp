...
<div class="container mt-3">
	<h3>${principal.user.nickname}님의 전문가 정보 등록하기</h3><br/>
...
<!-- 		<div class="form-group"> -->
<!-- 			<label for="uploaddocprofile">프로필 사진:</label> <input type="file" -->
<!-- 				id="uploaddocprofile" placeholder="사진을 등록해 주세요." -->
<!-- 				name="uploaddocprofile"> -->
<!-- 		</div> -->

<!-- 		<div class="form-group"> -->
<!-- 			<label for="uploaddoclicense">의사 면허증:</label> <input type="file" -->
<!-- 				id="uploaddoclicense" placeholder="면허증을 등록해 주세요." -->
<!-- 				name="uploaddoclicense"> -->
<!-- 		</div> -->
...
<script>
	$("#btnDocApproval").click(function() {
		var dataParam = {
			...
			"imagedocprofile":$("#uploaddocprofile").val(),
			"imagedoclicense":$("#uploaddoclicense").val(),
		}
		$.ajax({
			type : "POST",
			url : "/docinsert/"+$("#userid").val(),
