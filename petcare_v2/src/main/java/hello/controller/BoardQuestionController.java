...
public class BoardQuestionController {
	...
	public String boardQuestion(Model model,
			@PageableDefault(size = 5, sort = "questionID", direction = Direction.DESC) Pageable pageable,
	...
	public String bqinsert(BoardQuestion board, @AuthenticationPrincipal PrincipalUser principal, HttpSession session) {
